export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	megaleafeon: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 140, def: 160, spa: 60, spd: 75, spe: 115},
	...
	megaglaceon: {
		...
		types: ["Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 60, def: 140, spa: 170, spd: 105, spe: 85},
	...
	megagliscor: {
		...
		name: "Mega-Gliscor",
		types: ["Ground", "Flying"],
		baseStats: {hp: 75, atk: 135, def: 155, spa: 45, spd: 75, spe: 105},
